            ...
            let hd = {
                ...
                mouseMoveListener: (x, y) => {
                    ...
                    if (hd.md) {
                        ...
                        let columns = 1; //Math.floor(plate.grid.width / fixedWellWidth);
                        let rows = 2;//Math.floor(plate.grid.height / fixedWellHeight);
                        plate.grid.xmin = 0;
                ...
                mouseUpListener: async (x, y) => {
                    ...
                    if (hd.md) {
                        ...
                        plate.wellannotations['[0:0][0:0]'] = {
                            type: 'information',
                            label: '',
                            comment: 'Enter column name',
                            visible: true,
                            createdAt: Date.now(),
                            updatedAt: Date.now()
                        };
                        plate.wellannotations['[0:0][1:1]'] = {
                            type: 'information',
                            label: '',
                            comment: 'Enter formula',
                            visible: true,
                            createdAt: Date.now(),
                            updatedAt: Date.now()
                        };
