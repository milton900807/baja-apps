function (lib_id, file_id) {
    ...
    exec('flexigraph/gene.js').then(async (graph) => {
        ...
        window.history.pushState({ libid: lib_id }, 'Screen', `/app/baja/screens/open-screen-m.js?lib_id=${lib_id}&file_id=${file_id}`);
                    ...
                    tools_menu = [
                        {
                            'label': 'VCF/BED/Bigwig', 'ionfunction': createIonFunction(async () => {
                                ...
                                let hl = await exec('baja/screens/menu/data-tools.js', graph)
                                CurrentLayout.clearComponent('buttonMenuPanel|labelPanel')
                                CurrentLayout.setComponent('buttonMenuPanel', hl);
                            })
                        },
                        ...
                        },
                        {
                            'label': 'Primer-probes', 'ionfunction': createIonFunction(async () => {
                                let hl = await exec('baja/screens/menu/primer-probe-menu.js', graph)
                                CurrentLayout.clearComponent('buttonMenuPanel|labelPanel')
                                CurrentLayout.setComponent('buttonMenuPanel', hl);
                            })
                        },
