                                            ...
                                            'label': 'Mutation', 'items': [
                                                ...
                                                },
                                                {
                                                    'label': 'Mutation from track sequence...', 'ionfunction': createIonFunction(async () => {
                                                        ...
                                                        await exec('baja/screens/menu/mutation-from-track-sequence.js', graph)
                                                    })
                                                },
                                            ...
                                            'label': 'Edit', 'items': [
                                                {
                                                    'label': 'Mutations', 'ionfunction': createIonFunction(async () => {
                                                        ...
                                                        let snpsMenu = await exec('baja/screens/menu/snp-tools-mouse-menu.js', graph, genegraph_panel_layout)
