function (graph, genegraph_panel_layout) {
    ...
    if (!graph.props.selected_chemistry) {
        ...
        exec('screen/choose-chemistry.js', graph, genegraph_panel_layout)
        return;
    } else {
                ...
                'buttons': [
...

                    {
                        x: 3, y: 0, label: 'Edit', ionFunction: createIonFunction(async () => {
                            ...
                            let ediPanel = await exec('baja/screens/menu/compound-editor-panel.js', graph, genegraph_panel_layout);
