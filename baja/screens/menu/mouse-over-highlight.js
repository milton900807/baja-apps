function (graph, genegraph_panel_layout) {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        graph.addMouseDownListener(async (x, y) => {
                        ...
                        for (let o of oligo) {
                            if (o.highlight != null && o.structure != null) {
                                try {
                                    ...
                                    await exec('baja/screens/menu/menu-for-single-aso.js', graph, current, graph.genegraph_panel_layout)
                                    md = false;
                                    return;
            ...
            for (let t of graph.track) {
                const xWorld = Math.round(
                    t.tgraph.Xwc(graph.mousex - t.tgraph.xi * 2)
                );
                ...
                if (snp) {
                    snp.select();
                    const m = await exec('baja/screens/menu/snp-menu', graph, t, snp);
                    if (graph && graph.showSideMenu)
                        graph.showSideMenu(m);
                    return;
                }
            }
                    ...
                    menuList.push(
                        {
                            ...
                            click: async (scx, scy) => {
                                ...
                                exec('baja/screens/menu/label-plot-points-by-regular-expression.js', plot)
                            ...
                            const ssubmenu = [
                                {
                                    ...
                                    click: async () => {
                                        setTimeout(async () => {
                                            await exec('baja/screens/menu/text-box-action.js', graph)
                                            graph.showSideMenu(null);
                                        }, 400)
                                    }
                                },
                                {
                                    ...
                                    click: async () => {
                                        setTimeout(async () => {
                                            ...
                                            await exec('baja/screens/menu/draw-rect-action.js', graph)
                                            graph.showSideMenu(null);
                                        }, 400)
                                    ...
                                    click: async () => {
                                        setTimeout(async () => {
                                            ...
                                            await exec('baja/screens/menu/draw-oval-action.js', graph)
                                            graph.showSideMenu(null);
                                        }, 400)
                                ...
                                },
                                {
                                    ...
                                    click: async () => {
                                        setTimeout(async () => {
                                            await exec('baja/screens/menu/draw-line-action.js', graph)
                                            graph.showSideMenu(null);
                                        }, 400)
                            ...
                            const golist = [
                                {
                                    ...
                                    click: async (scx, scy) => {
                                        ...
                                        await exec('baja/screens/menu/edit-current-track.js', graph, genegraph_panel_layout, selectedTrack)
                                    },
                                },
                                ...annotations_menu,
                        ...
                        click: async (scx, scy) => {
                            ...
                            const golist = [
                                ...
                                },
                                {
                                    ...
                                    click: async (scx, scy) => {
                                        if (selectedTrack) {
                                            let track_layers_panel = await exec('baja/screens/menu/select-track-action-layers-edit-panel.js',
