        ...
        let buttons__ = [
...

            {
                x: 1, y: 0, label: 'Splice Vis', ionFunction: createIonFunction(async () => {
                    ...
                    await exec('baja/screens/menu/splicing/exon-for-lj-splice.js', graph, genegraph_panel_layout)

                })
            },
            {
                x: 2, y: 0, label: 'PTC Vis', ionFunction: createIonFunction(async () => {
                    await exec('baja/screens/menu/splicing/ptc-arcs.js', graph, genegraph_panel_layout)
                })
            },
        ]
