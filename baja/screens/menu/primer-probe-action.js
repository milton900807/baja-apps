                        ...
                        let temp = async (graph) => {
                            ...
                            if (spreadPrimers) {
                                ...
                                for (let i = 0; i < interval; i++) {
                                    ...
                                    let primer_ = await exec('baja/screens/ppsets/apply-primer3.js', r, chunkSize * i, tr, graph)
                                ...
                                POSTJSON({
                                    ...
                                    exec('baja/screens/annotation/apply-variant-amplicon.js', res, tr, splicekeys).then(primer_probe => {
