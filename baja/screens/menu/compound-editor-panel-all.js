            ...
            'buttons': [
                {
                    x: 0, y: 0, label: 'SynthesisSeq', ionFunction: createIonFunction(async () => {
                        exec ( 'baja/screens/menu/annotation/synthesis-sequence-def.js', graph, genegraph_panel_layout)
                ...
                },
                {
                    x: 3, y: 0, label: 'Delete', ionFunction: createIonFunction(async () => {
                        ...
                        let hl = await exec('baja/screens/menu/compound-delete-panel.js', graph, genegraph_panel_layout)
