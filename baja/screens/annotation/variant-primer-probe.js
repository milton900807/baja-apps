        ...
        if ( createprimers && !probedesign && !illumina) {
            ...
            if ( anchorcoord ) {
                ...
                .then  ( res => {
                    ...
                    exec( 'baja/screens/annotation/apply-variant-amplicon.js', res, selectedTrack, rightkeys, 'right').then(primer_probe => {
            ...
            if ( anchorcoord ) {
                ...
                .then  ( res => {
                        ...
                        exec( 'baja/screens/annotation/apply-variant-amplicon.js', res, selectedTrack, leftkeys, 'left').then(primer_probe => {
                            selectedTrack.addOligo(primer_probe);
                        });
                    })
            } else {
            ...
            if ( anchorcoord ) {
                ...
                POSTJSON ( {
                    ...
                    mid:anchorcoord,
                        ...
                        exec( 'baja/screens/annotation/apply-variant-amplicon.js', res, selectedTrack, midkeys, 'mid').then(primer_probe => {
                            selectedTrack.addOligo(primer_probe);
                        });
                    })
            } else {
            ...
            if ( anchorcoord ) {
                ...
                POSTJSON ( {
                    ...
                    justprobe:anchorcoord,
                        ...
                        exec( 'baja/screens/annotation/apply-variant-amplicon.js', res, selectedTrack, midkeys, 'mid').then( async (primer_probe) => {
                            let compDesign = '1';
                            if (compDesign) {
