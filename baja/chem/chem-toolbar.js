function (graph, library, parent_panel) {
    let editor_;
                    ...
                    x: 0, y: 0, label: 'Chemistry preferences', ionFunction: createIonFunction(async () => {
                        let selectMethod = async (v) => {
                            ...
                            if (v.name != null && v.name.endsWith('.json')) {
                                v.name = v.name.substring(0, v.indexOf('.json'))
                            }
                                                ...
                                                data: [
                                                    ...
                                                    },
                                                    {
                                                        'label': 'Cancel', ionfunction: createIonFunction(() => {
                                                            ...
                                                            CurrentLayout.setComponent('mainPanel', parent_panel);
                        ...
                        console.log(" loading the main panel ")
                        hideAllModal();
                        CurrentLayout.clearComponent('mainPanel')
