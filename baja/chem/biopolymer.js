    ...
    return new Promise(async (resolve, reject) => {
        ...
        class Biopolymer {
            ...
            static generateDNAOligo(name, synthesisSeq, bioObj) {
                ...
                const templateStructure = `RNA1{${helmTokens.join(".")}}$$$$V2.0`;
            ...
            static createOligoFromTemplateUseSeqIn(chemObj, track, tstart, sequence, y, idv) {
                ...
                let oligo = new Oligo(type, sequence, antisense, tstart, (tstart + base_count), y);
            ...
            static createOligoFromTemplate(chemObj, track, tstart, base_count, y) {
                ...
                if (type === 'siRNA') {
                    let oligo = new SIRNA(type, synthesisSeq, synthesisSeq, subseq, sense, antisense, tstart, (tstart + base_count), y, track.strand);

                    track.addOligo(oligo);

                } else {

                    let oligo = new Oligo(type, subseq, antisense, tstart, (tstart + base_count), y);
                    oligo.strand = track.strand;
