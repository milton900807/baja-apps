            ...
            let buttons__ = [
                {
                    x: 0, y: 0, label: 'Mutations', ionFunction: createIonFunction(async () => {
                        ...
                        await exec('baja/manchester/menu/annotation/mutation.js', graph)
                    })
                },
                {
                    x: 1, y: 0, label: 'Draw...', ionFunction: createIonFunction(async () => {
                        await exec('baja/manchester/menu/annotation/draw.js', graph)
                    })
                },
                {
                ...
                },
                {
                    x: 3, y: 0, label: 'Feature overlap', ionFunction: createIonFunction(async () => {
                        ...
                        await exec('baja/manchester/menu/genomic-overlap-menu.js', graph)
                    })
                },
                {
...

                {
                    ...
                    label: 'Track annotations...', ionFunction: createIonFunction(async () => {
                        ...
                        await exec('baja/manchester/menu/add-track-annotations.js', graph, lib, folder)
                    })
                },
                {
