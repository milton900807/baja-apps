        ...
        if (selectedTrack) {
            ...
            if ( cluster ){
                menuList.push({
                    ...
                    click: async (xwc, ywc) => {
                        if (selectedTrack) {
                            ...
                            exec ( 'baja/manchester/menu/cluster-polygons-on-tracklayers-panel.js', graph, genegraph_panel_layout, selectedTrack, selectedTrack.tgraph.xmin, selectedTrack.tgraph.xmax, xwc, ywc)
                        }
                    },
                    move: () => {
                        log('')
                ...
                menuList.push({
                    ...
                    click: async (xwc, ywc) => {
                        if (selectedTrack) {
                            exec ( 'baja/manchester/menu/cluster-polygons-on-tracklayers-panel.js', graph, genegraph_panel_layout, selectedTrack, selectedTrack.markstart, selectedTrack.markend)
                        }
                    },
                    move: () => {
                        log('')
