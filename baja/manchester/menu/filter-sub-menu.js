                                            ...
                                            'label': 'Quick filters', 'items': [
                                                {
                                                    'label': 'Remove homopolymer contigs', 'ionfunction': createIonFunction(async () => {
                                                        await exec('baja/manchester/annotation/rule-application-wizard-min.js', graph, genegraph_panel_layout, `pattern, TTTT | Required\npattern, AAAA | Required\npattern, CCCC | Required\npattern, GGGG | Required
                                                        `)
                                                ...
                                                },
                                                {
                                                    'label': 'Remove palindromes', 'ionfunction': createIonFunction(async () => {
                                                        await exec('baja/manchester/annotation/rule-application-wizard-min.js', graph, genegraph_panel_layout, `palindrome,10 | Required`)
