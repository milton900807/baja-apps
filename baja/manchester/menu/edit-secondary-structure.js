function (graph, genegraph_panel_layout) {
    ...
    let menuList = [

        {
            ...
            click: async () => {
                await exec('baja/manchester/menu/design-on-secondary-structure-fixed-chem.js', graph);
        ...
        },
        {
            ...
            click: async () => {
                await exec('baja/manchester/menu/design-on-secondary-structure.js', graph);
        ...
        },
        {
            label: 'Tile',
            click: async () => {
                await exec('baja/manchester/menu/design-on-secondary-structure-tile.js', graph);
