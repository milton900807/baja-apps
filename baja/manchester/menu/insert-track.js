                                ...
                                [
                                    {
                                        ...
                                        'component': {
                                            ...
                                            data: {
                                                'show-button': false,
                                                'title': 'Describe the transcript (e.g. "canonical FGFR3 in human")',
                                                'ionHookFunction': createIonFunction((input_box) => {
                                                    v = input_box;
                                                })
                                            }
                                        ...
                                        'component': {
                                            wid: 'mt-button', data: {
                                                buttons: [
                                                    {
                                                        label: 'Load', ionFunction: createIonFunction(async () => {
                                                            let q = (v && v.value) ? v.value : '';
                                                            hideAllModal();
                                                            await exec('baja/data/prompt-load-transcript.js', window['env']['apiUrl'], graph, null, q)
                                                        })
                                                    },
                                                    {
                                                        label: 'Cancel', ionFunction: createIonFunction(() => {
