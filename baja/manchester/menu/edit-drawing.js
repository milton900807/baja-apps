            ...
            if (this.selectedObject) {
                menuList.push({
                    ...
                    click: (xwc, ywc) => {
                        ...
                        exec('baja/manchester/editor/' + this.selectedObject.type + '-editor.js', this.selectedObject, graph, genegraph_panel_layout)
                    },
                    move: () => {
                    }
                })
                ...
                menuList.push({
                    ...
                    click: (xwc, ywc) => {
                        ...
                        exec ( 'baja/manchester/editor/move-items.js', graph, genegraph_panel_layout)
