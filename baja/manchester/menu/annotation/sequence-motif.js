function (graph, io) {
    ...
    let m = {
        'label': 'Motif', 'ionfunction': createIonFunction(() => {
                                                            ...
                                                            buttons: [
                                                                {
                                                                    label: 'Apply', ionFunction: createIonFunction(async () => {
                                                                        ...
                                                                        complement = reverseComp(complement);
                                                                        let index = 0;
                                                            ...
                                                            buttons: [
                                                                {
                                                                    label: 'Apply', ionFunction: createIonFunction(async () => {
                                                                        ...
                                                                        for (let s = 0; s < (seq.length - complement.length); s++) {
                                                                            ...
                                                                            if (sub.toUpperCase () === complement.toUpperCase () || v <= editDistance) {
                                                                                console.log('debubg');

                                                                                alert ( ' adding sequencw ')
