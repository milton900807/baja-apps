                                            ...
                                            'label': 'Primer-probes', 'items': [
                                                {
                                                    'label': 'New primers...', 'ionfunction': createIonFunction(async () => {
                                                        ...
                                                        graph.rungraph(async () => { await exec('baja/manchester/menu/primer-probe-action.js', graph, genegraph_panel_layout) })
...

                                                {
                                                    'label': 'Edit', 'ionfunction': createIonFunction(async () => {
                                                        graph.setMessage('Select a track ')
                                                        graph.rungraph(async () => { await exec('baja/manchester/menu/primer-probe-action-edit.js', graph, genegraph_panel_layout) })
                                                        CurrentLayout.setComponent('labelPanel', {
                                                            wid: 'html',
                                                            data: ' Click on a track to see menu options... '
                                                        })
