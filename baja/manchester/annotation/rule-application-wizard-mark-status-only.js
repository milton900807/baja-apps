                        ...
                        },
                        {
                            ...
                            'component': {
                                wid: 'mt-button', data: {
                                    buttons: [
                                        {
                                            label: 'Tag', ionFunction: createIonFunction(async () => {
                                                ...
                                                let my_rules = await exec('baja/manchester/annotation/rule-parser.js', rules, graph);
                                                ...
                                                await exec('baja/manchester/annotation/publish-rules.js', graph, lib, folder, my_rules);
                                                let startidx = 231000;

                                                await exec('baja/manchester/annotation/publish-oligos.js', graph, lib, folder, alloligos, my_rules, startidx);
                                        ...
                                        },
                                        {
                                            label: 'Test', ionFunction: createIonFunction(async () => {
                                                ...
                                                working.status = 'complete';
                                                hideAllModal();
                                                await exec('baja/manchester/annotation/rule-application-wizard.js', lib, folder, graph, rules, _filtern);
                                            })
                                        },
                                        {
