                ...
                menuList.push(
                    {
                        ...
                        click: async(x) => {
                            ...
                            if ( variant != null ) {
                                await exec('baja/manchester/annotation/variant-primer-probe.js', variant, selectedTrack, graph, false, true, null)
                            } else {
                ...
                menuList.push(
                    {
                        ...
                        click: async(x) => {
                            ...
                            if ( variant != null ) {
                                await exec('baja/manchester/annotation/variant-primer-probe.js', variant, selectedTrack, graph, false, null, true)
                            } else {
                                graph.setMessage('Click closer to variant')
                            }
                        },
                ...
                menuList.push(
                    {
                        ...
                        click: async(x) => {
                            ...
                            if ( variant != null ) {
                                await exec('baja/manchester/annotation/variant-primer-probe.js', variant, selectedTrack, graph, true, true)
                            } else {
                                graph.setMessage('Click closer to variant')
                            }
                        },
                        ...
                        if ( selectedTrack.targetPhase != null ) {
                            ...
                            for ( let v of variants ) {
                                if ( v.xi > selectedTrack.xi && v.xf < selectedTrack.xf ) {
                                    await exec('baja/manchester/annotation/variant-primer-probe.js', v, selectedTrack, graph, false, true);
                                }
                            }
                            for ( let v of variantso ) {
                                if ( v.xi > selectedTrack.xi && v.xf < selectedTrack.xf ) {
                                    await exec('baja/manchester/annotation/variant-primer-probe.js', v, selectedTrack, graph, true, true);
                                }
                            }
                        } else {
