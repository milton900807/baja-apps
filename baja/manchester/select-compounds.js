                ...
                'buttons': [
...

                    {
                        x: 5, y: 0, label: 'OT', ionFunction: createIonFunction(async () => {
                            ...
                            await exec('baja/manchester/menu/run-off-targets.js', graph, genegraph_panel_layout, selected)
                    ...
                    },
                    {
                        x: 6, y: 0, label: 'Move', ionFunction: createIonFunction(() => {
                            ...
                            exec('baja/manchester/select-compounds-move.js', graph, genegraph_panel_layout)
                        }),
                    },
