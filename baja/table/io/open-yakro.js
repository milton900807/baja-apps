function (graph, pm, reference_object) {
                                    ...
                                    data: {
                                        ...
                                        "ionfunction.fileClick": createIonFunction(async (element) => {
                                            ...
                                            setTimeout(async () => {
                                                ...
                                                window.history.pushState({ 'yak': currentPath }, 'editor', `${reference_object}?path=${currentPath}`);
                                                ...
                                                setTimeout(async () => {
                                                    ...
                                                    graph.update(rs);
                                                    if (pm.plateTrack)
                                                        pm.plateTrack.file = jsonobj.path

                                                    if (pm.file) {
                                                        pm.file = jsonobj.path;
                                                    }
