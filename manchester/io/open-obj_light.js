            ...
            let ww = {
                ...
                data: {
                    ...
                    "ionfunction.fileClick": createIonFunction(async (element) => {
                        ...
                        exec('manchester/screening_editor', replaceFirstNode(element.path), config)
                        let iconlist = [{
                            ...
                            items: [
                                {
                                    ...
                                    ionfunction: createIonFunction(() => {
                                        ...
                                        exec('manchester/screening_editor.js')
                        ...
                        [
                            {
                                ...
                                'component':
                                {
                                    ...
                                    data: {
                                        ...
                                        "ionfunction.fileClick": createIonFunction(async (element) => {
                                            clear();
                                            exec('manchester/screening_editor', replaceFirstNode(element.path))
