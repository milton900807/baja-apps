function (graph, main_layout, path, reference_object, image) {
    return new Promise(async (resolve, reject) => {
        ...
        let init_path = 'internal/' + getUser();
                                                    ...
                                                    ionfunction: createIonFunction(async () => {
                                                                     ...
                                                                     try {
                                                                         const rs = await POSTJSON({
                                                                             "key": "user",
                                                                             "user": getUser(),
                                                                             "spath": 'internal/' + directory + '/' + foldername
                                                                         }, host_ + '/save-to-user-public');
                                ...
                                data: {
                                    ...
                                    buttons: [{
                                        ...
                                        'label': 'Save', 'function': createIonFunction(async (button_label, input_params) => {
                                            ...
                                            let rs = await POSTJSON(jsonobj, host_ + '/save-to-user-internal');
                                            if (image) {
                                                let thumb = {
                                                    "name": name + '.png',
                                                    "key": "user",
                                                ...
                                                let rts = await POSTJSON(thumb, host_ + '/save-to-user-internal');
                                            }
