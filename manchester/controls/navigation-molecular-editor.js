    ...
    return new Promise(async (resolve, reject) => {
        ...
        buttons = [
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-benzene-ring.js',
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-cyclohexane-ring.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    const r = Math.min(w, h) * 0.23;
                    const pts = [];
                    for (let i = 0; i < 6; i++) {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-morpholine-ring.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    const r = Math.min(w, h) * 0.23;
                    const pts = [];
                    for (let i = 0; i < 6; i++) {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-piperazine-ring.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    const r = Math.min(w, h) * 0.23;
                    const pts = [];
                    for (let i = 0; i < 6; i++) {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-hydroxyl-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-amine-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-carboxyl-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-amide-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 14, cy, cx - 3, cy);
                    drawDoubleBond(ctx, cx - 2, cy, cx + 10, cy - 8, '#0a84ff', 1.2, 1.2);
                    drawBond(ctx, cx - 2, cy, cx + 10, cy + 8);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-ester-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 14, cy, cx - 3, cy);
                    drawDoubleBond(ctx, cx - 2, cy, cx + 10, cy - 8, '#0a84ff', 1.2, 1.2);
                    drawBond(ctx, cx - 2, cy, cx + 10, cy + 8);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-aldehyde-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-ketone-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 14, cy, cx - 2, cy);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-ether-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-alkene-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-alkyne-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-nitrile-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-nitro-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 14, cy, cx - 3, cy);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-sulfone-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 14, cy, cx - 4, cy);
                    drawBond(ctx, cx + 4, cy, cx + 14, cy);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-phosphate-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-fluoro-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 10, cy, cx + 2, cy);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-chloro-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 10, cy, cx + 2, cy);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-bromo-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 10, cy, cx + 2, cy);
            ...
            makeMolButton({
                ...
                action: 'baja/manchester/menu/molecule/draw-iodo-group.js',
                drawIcon: (ctx, xx, yy, w, h, cx, cy) => {
                    drawBond(ctx, cx - 10, cy, cx + 2, cy);
