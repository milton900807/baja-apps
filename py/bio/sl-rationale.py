...
SYSTEM = (
    ...
    "FDR and synergy (or the paralog model probability and features) say, and what they do not. "
    "A 'driven by X' or 'single-loss' label means the second loss is a passenger; say so.\n"
...
if not target:
    ...
    if source == "paralog":
        ...
        ask = ("Target: %s\nLosses in the tumour (the background): %s\n%s"
               ...
               "the mean knockout effect in background lines, more negative = more essential; synergy = "
