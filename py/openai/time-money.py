...
"""
+TenYear_View_Cols builder (GPT-driven, label-only refs, growth-aware)
...
REQUIRED ROWS in the output table "TenYear_View_Cols":
  - Total_Profit
  - Profit_Margin_YoY
  - cash_on_hand
...
TenYear_View_Cols[1:1][3:3]  = Capital_Assumptions[Initial_Capital_Investment] + TenYear_View_Cols[Total_Profit, Y2025]
TenYear_View_Cols[2:2][3:3]  = TenYear_View_Cols[Cash, Y2025] + TenYear_View_Cols[Total_Profit, Y2026]
TenYear_View_Cols[3:3][3:3]  = TenYear_View_Cols[Cash, Y2026] + TenYear_View_Cols[Total_Profit, Y2027]
TenYear_View_Cols[4:4][3:3]  = TenYear_View_Cols[Cash, Y2027] + TenYear_View_Cols[Total_Profit, Y2028]
TenYear_View_Cols[5:5][3:3]  = TenYear_View_Cols[Cash, Y2028] + TenYear_View_Cols[Total_Profit, Y2029]
TenYear_View_Cols[6:6][3:3]  = TenYear_View_Cols[Cash, Y2029] + TenYear_View_Cols[Total_Profit, Y2030]
TenYear_View_Cols[7:7][3:3]  = TenYear_View_Cols[Cash, Y2030] + TenYear_View_Cols[Total_Profit, Y2031]
TenYear_View_Cols[8:8][3:3]  = TenYear_View_Cols[Cash, Y2031] + TenYear_View_Cols[Total_Profit, Y2032]
TenYear_View_Cols[9:9][3:3]  = TenYear_View_Cols[Cash, Y2032] + TenYear_View_Cols[Total_Profit, Y2033]
TenYear_View_Cols[10:10][3:3] = TenYear_View_Cols[Cash, Y2033] + TenYear_View_Cols[Total_Profit, Y2034]
...
def build_ten_year_view_gpt(src_root: Any, years_ahead: int = 11, model: str = "gpt-4o-mini", temperature: float = 0.15) -> Dict[str, Any]:
    ...
    return {
        ...
        "units": units,
        "diagnostics": {"start_year": start_year, "years": years, "uses_growth": has_growth_rate(tables), "growth_ref": _find_growth_ref(present)}
    }
