        ...
        exec('baja/screens/modal/label-bookmark.js', graph).then(async m => {
            ...
            if (isMobile()) {
                ...
                bbuttons = [
                    {
                     ...
                     {
                        x: 2, y: 0, label: 'Box zoom', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                    ...
                    {
                        x: 4, y: 0, label: 'resize x', ionFunction: createIonFunction(() => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                ...
                buttons = [
                    ...
                    {
                        x: 16, y: 0, label: 'Show Bookmark', ionFunction: createIonFunction(async () => {
                    ...
                    {
                        x: 18, y: 0, label: 'Show Tracks', ionFunction: createIonFunction(async () => {
                    ...
                    {
                        x: 24, y: 0, label: 'resize x', ionFunction: createIonFunction(() => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                            graph.setMessage('Contract in x direction')
                    ...
                    {
                        x: 26, y: 0, label: 'expand down', ionFunction: createIonFunction(() => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                            graph.setMessage('Expand in the x direction ')
...

                    {
                        x: 28, y: 0, label: 'expand down', ionFunction: createIonFunction(() => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('none')
                            graph.setMessage ( "The canvas is frozen.")
