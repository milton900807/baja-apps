function (graph, genegraph_panel_layout) {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        exec('baja/screens/modal/label-bookmark.js', graph).then(async m => {
            ...
            if (isMobile()) {
                buttons = [
                    ...
                    {
                        x: 2, y: 0, label: 'expand down', ionFunction: createIonFunction(() => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                    ...
                    {
                        x: 4, y: 0, label: 'Bookmark', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                    ...
                    {
                        x: 6, y: 0, label: 'Show Bookmark', ionFunction: createIonFunction(async () => {
                    ...
                    {
                        x: 8, y: 0, label: 'Show Tracks', ionFunction: createIonFunction(async () => {
                    ...
                    {
                        x: 10, y: 0, label: 'Move canvas', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                        ...
                        x: 12, y: 0, label: 'Box zoom', ionFunction: createIonFunction(async () => {
                            ...
                            await exec('baja/screens/menu/zoom-box.js', graph)
                ...
                buttons = [
                    ...
                    {
                        x: 20, y: 0, label: 'Bookmark', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                            graph.setMessage('Create a bookmark')
                    ...
                    {
                        x: 22, y: 0, label: 'Show Bookmark', ionFunction: createIonFunction(async () => {
                    ...
                    {
                        x: 24, y: 0, label: 'Show Tracks', ionFunction: createIonFunction(async () => {
                    ...
                    {
                        x: 28, y: 0, label: 'Move options', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('navigate')
                            graph.setMessage('Move the window by clicking and dragging')
                        ...
                        x: 30, y: 0, label: 'Box zoom', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                            graph.setMessage("Zoom:  Drag a rectangle ")
                            graph.setMouseMode('none')
                            await exec('baja/screens/menu/zoom-box.js', graph)
                    ...
                    {
                        x: 32, y: 0, label: 'Freez', ionFunction: createIonFunction(async () => {
                            graph.clearMouseListeners();
                            graph.setMouseMode('none')
