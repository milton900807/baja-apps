function (plate_graph) {
    return new Promise(async (resolve, reject) => {
        ...
        let buttons = [
            ...
            {
                x: 14, y: 0, label: 'Left', ionFunction: createIonFunction(async () => {
            ...
            {
                x: 16, y: 0, label: 'Right', ionFunction: createIonFunction(async () => {
                    AnimateGrid.INTERUPT = true;
                    plate_graph.plateTrack.grid.rescale();
                    let ymax = plate_graph.plateTrack.grid.ymax;
                    let ymin = plate_graph.plateTrack.grid.ymin;
            ...
            {
                x: 18, y: 0, label: 'Bookmark', ionFunction: createIonFunction(async () => {
            ...
            {
                x: 20, y: 0, label: 'Help', "ionFunction": createIonFunction(async () => {
                    setTimeout(() => {
