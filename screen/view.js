function (path, config) {
    ...
    showWidget({
        ...
        exec('flexigraph/gene.js', progressBar).then(async (graph) => {
            ...
            let button_canvas = await exec('screen/controls/navigation-panel-view.js', graph)
            let plates_panel;
            ...
            tools_menu = [
                ...
                },
                {
                    'label': 'Draw', 'ionfunction': createIonFunction(async () => {
                        ...
                        let hl = await exec('baja/screens/menu/draw-editor.js', graph, genegraph_panel_layout)
                        CurrentLayout.clearComponent('buttonMenuPanel|labelPanel')
