function (path, config) {
    ...
    showWidget({
        ...
        exec('flexigraph/gene.js', progressBar).then(async (graph) => {
            ...
            let button_canvas = await exec('baja/screens/menu/assay-tools-buttons.js', graph)
            ...
            track_items.push({
                'label': 'New RNA track', 'ionfunction': createIonFunction(() => {
            ...
            tools_menu = [
                ...
                {
                    'label': 'Primers', 'ionfunction': createIonFunction(async () => {
                                ...
                                'component': {
                                    ...
                                    data: {
                                        menus: [
                                            ...
                                            exptracks,
                                            {
                                                'label': 'Design', 'icon': 'more_vert', 'items': tools_menu
                                            },
                                            {
