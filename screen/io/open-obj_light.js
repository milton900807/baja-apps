            ...
            let ww = {
                ...
                data: {
                    ...
                    "ionfunction.fileClick": createIonFunction(async (element) => {
                        ...
                        exec('screen/screening_editor', replaceFirstNode(element.path), config)
                        let iconlist = [{
                            ...
                            items: [
                                {
                                    ...
                                    ionfunction: createIonFunction(() => {
                                        ...
                                        exec('screen/screening_editor.js')
                        ...
                        [
                            {
                                ...
                                'component':
                                {
                                    ...
                                    data: {
                                        ...
                                        "ionfunction.fileClick": createIonFunction(async (element) => {
                                            clear();
                                            exec('screen/screening_editor', replaceFirstNode(element.path))
