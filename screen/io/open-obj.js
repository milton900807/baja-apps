            ...
            let ww = {
                ...
                data: {
                    ...
                    "ionfunction.fileClick": createIonFunction(async (element) => {
                        ...
                        exec('screen/editor', replaceFirstNode(element.path), config)
                        let iconlist = [{
                                ...
                                'component':
                                {
                                    ...
                                    data: {
                                        ...
                                        "ionfunction.fileClick": createIonFunction(async (element) => {
                                            ...
                                            window.history.replaceState('', 'editor', `/app/screen/editor?path=${element.path}`);

                                            exec('screen/editor', replaceFirstNode(element.path))
