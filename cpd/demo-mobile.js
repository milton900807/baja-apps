        ...
        exec('flexigraph/gene2plates.js', pm, progressBar).then(async (graph) => {
            ...
            if (!timesup) {
                ...
                ai_create_file_items.push(
                    makeAiCreateItem('Milestones', async () => {
                        ...
                        const txt =
                            ` give me milestones for all major medical achievements for the last 10 years.`;
                        let initalText = true;
                        setTimeout(() => {
                            let i = 0;
                            let currentText = '';
  ...
  <font color="navy">Write a short paragraph that describes the timeline you want to create.  (BCE currently not supported)</font>
                ...
                ai_create_file_items.push(
                    makeAiCreateItem('Publications Timeline', async () => {
                        ...
                        const txt =
                            'Give me a timeline that describes key milestones for the discovery vaccines and add to this specific milestones for the discovery of the covid vaccine. ';
                        let initalText = true;
                        setTimeout(() => {
                            let i = 0;
                            let currentText = '';
...
9. Large animal toxicology  20 weeks
 `;
  ...
  <font color="navy">
                                                    ...
                                                    buttons: [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            ionFunction: createIonFunction(async () => {
                                                                ...
                                                                plot.fitScaleToData = false;
                                                                plot.grid.rescale();
                                                                pm.plateTrack.distributeYValues()
                                                                pm.plateTrack.setPlotCenter(plot);
                ...
                ai_create_file_items.push(makeAiCreateItem('Profit & Loss', async () => {
                ...
                ai_create_file_items.push(makeAiCreateItem('10 year Financials', async () => {
                    const plate_graph = pm;
                    const pt = pm.plateTrack;
                    let sequenceTextEditor;
                    let descHook = createIonFunction((p) => {
                ...
                ai_create_file_items.push(makeAiCreateItem('Budget generator', async () => {
                    const plate_graph = pm;
                    const pt = pm.plateTrack;
                    let sequenceTextEditor;
                    let descHook = createIonFunction((p) => {
            ...
            setTimeout(() => {
                ...
                pm.plateTrack.showMenu(ai_create_file_items)
            }, 1000)
        })
