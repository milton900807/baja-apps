function (path, config) {
    ...
    showWidget({
        ...
        exec('flexigraph/gene2plates.js', pm, progressBar).then(async (graph) => {
            ...
            if (config.app && config.app === 'bajabio Project') {
                        ...
                        data: {
                            ...
                            menus: [
                                    ...
                                    items: [

                                        {
                                            label: 'Table', ionfunction: createIonFunction(async () => {
                                                await exec('baja/draw/table-selection-list', pm, 'baja/templates/ptxproject')
                                            })
                                        },
                                ...
                                },
                                {
                                    'label': 'Ops', 'items': [
                                        {
                                            label: 'Set type', ionfunction: createIonFunction(async () => {
                                                ...
                                                let t = {
                                                    ...
                                                    data: {
                                                        ...
                                                        button_function: createIonFunction(async (items) => {
                                                            ...
                                                            if (selectedLabel === 'Timeline') {
                                                                pm.plateTrack.type = 'main-timeline';
                                                            }
                            ...
                            menus: [
...

                                {
                                    ...
                                    items: [
                                                ...
                                                try {
                                                    ...
                                                    const renderTree = async (nodeList, panelName = 'mainPanel') => {
                                                        ...
                                                        const buildDesc = async (items) => {
                                                            ...
                                                            for (let i of items) {
                                                                try {
                                                                    let r = await load_file(spath + '' + dir, i.label + '.desc');
                                                                    if (r && r.rule_value)
                                                                        i.desc = r.rule_value;
                                                                } catch (exception) { }
                                                                if (i && i.desc) {
                                                ...
                                                try {
                                                    ...
                                                    const renderTree = async (nodeList, panelName = 'mainPanel') => {
                                                        ...
                                                        const buildDesc = async (items) => {
                                                            ...
                                                            for (let i of items) {
                                                                try {
                                                                    let r = await load_file(spath + '' + dir, node.name + '.desc');
                                                                    if (r && r.rule_value)
                                                                        i.desc = r.rule_value;
                                                                } catch (exception) { }
                                                                if (i && i.desc) {
                                        ...
                                        {
                                            label: 'Clipboard', ionfunction: createIonFunction(async () => {
                                                await exec('baja/draw/draw-clipboard', pm.plateTrack)
                                            })
                                        },
                                        {
