        ...
        exec('flexigraph/gene2plates.js', pm, progressBar).then(async (graph) => {
            ...
            let publicPublish = async () => {
                ...
                if (pm.plateTrack && im) {
                    ...
                    await exec('screen/io/save-as-obj-tp-public.js', graph, genegraph_panel_layout, path, '/app/cpd/bajabio-analytics', im)
                } else {
                    await exec('screen/io/save-as-obj-tp-public.js', graph, genegraph_panel_layout, path, '/app/cpd/bajabio-analytics')
                }
            }
            progressBar(80);
                    ...
                    let confirm = await exec(
                        ...
                        async () => {
                            ...
                            let button_canvas2 = await exec(
                                'screen/controls/navigation-panel-plates2.js',
                                pm,
                                null
                            )
                ...
                file_items.push({
                    ...
                    click: async (xwc, ywc) => {
                        ...
                        if (pm.plateTrack && im) {
                            ...
                            await exec(
                                'screen/io/save-as-obj-tp-internal-news.js',
                                graph,
  ...
  <font color="navy">Write a short paragraph that describes the timeline you want to create. </font>
                ...
                if (result.allowed) {
                    let publicNewsPublish = async () => {
                        ...
                        let im = pngBase64.replace(/^data:image\/png;base64,/, '');
                        if (pm.plateTrack && im) {
                            await exec('screen/io/save-as-obj-tp-internal-news.js', graph, genegraph_panel_layout, path, '/app/cpd/bajabio-analytics', im)
                        } else {
                            await exec('screen/io/save-as-obj-tp-internal-news.js', graph, genegraph_panel_layout, path, '/app/cpd/bajabio-analytics')
                        }
                    }
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        label: 'Moledulear Editor', ionfunction: createIonFunction(async () => {
                                            let button_canvas2 = await exec('screen/controls/navigation-molecular-editor.js', graph)
                                            CurrentLayout.setComponent('selectedPanel', button_canvas2)
                                        })
                                    },
                                    {
