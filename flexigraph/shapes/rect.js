        ...
        let Rectangle = class Rectangle {
            ...
            draw(graph, ctx) {
                ...
                if (ctx) {
                    ...
                    ctx.save();
                    // Tropical drag rectangle: translucent orange wash + dashed cyan border + glow.
                    ctx.shadowColor = 'rgba(18,194,224,0.55)';   // cyan glow
                    ctx.shadowBlur = 10;
                    ctx.fillStyle = 'rgba(255,140,26,0.14)';     // tropical orange wash
                    ...
                    graph.drawRect(graph.X(this.x), graph.Y(this.y), graph.screenWidth(this.w), graph.screenHeight(this.h), '#12c2e0', 3);
                    if (this.hl)
                        graph.drawRect(graph.X(this.x), graph.Y(this.y), graph.screenWidth(this.w), graph.screenHeight(this.h), '#ff8c1a', 3);
                    if (this.comment) {
